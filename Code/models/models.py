...
class Model_vault:
  ...
  def create_base_model(self):
    ...
    y = layers.Conv1D(8, kernel_size=3, strides=1, activation='relu', padding='same') (y)
  ...
  def create_fcn(self):
    ...
    y = layers.Conv1D(8, kernel_size=3, strides=1, activation='relu', padding='same') (y)
    y = layers.MaxPooling1D()(y)
    y = layers.Conv1D(16, kernel_size=3, strides=1, activation='relu', padding='same') (y)
    y = layers.Conv1D(24, kernel_size=3, strides=1, activation='relu', padding='same') (y)
    y = layers.Conv1D(32, kernel_size=3, strides=1, activation='relu', padding='same') (y)
    y = layers.Conv1D(48, kernel_size=3, strides=1, activation='relu', padding='same') (y)
    y = layers.Conv1D(1, kernel_size=3, strides=1, padding='same') (y)
  ...
  def create_fcn_residual(self):
    ...
    y = self._standard_scaler(x)
    y = layers.Conv1D(8, kernel_size=3, strides=1, activation='elu', padding='same') (y)
    y = layers.MaxPooling1D()(y)
    y = self._residual_block(y, 16, 8)
    y = layers.Conv1D(16, kernel_size=3, strides=1, activation='elu', padding='same') (y)
    y = self._residual_block(y, 24, 16)
    y = layers.Conv1D(24, kernel_size=3, strides=1, activation='elu', padding='same') (y)
    y = self._residual_block(y, 32, 24)
    y = layers.Conv1D(32, kernel_size=3, strides=1, activation='elu', padding='same') (y)
    y = self._residual_block(y, 48, 32)
    y = layers.Conv1D(48, kernel_size=3, strides=1, activation='elu', padding='same') (y)
    y = self._residual_block(y, 64, 48)
    y = layers.Conv1D(64, kernel_size=3, strides=1, activation='elu', padding='same') (y)
    y = layers.Conv1D(1, kernel_size=3, strides=1, padding='same') (y)
    y = layers.GlobalAveragePooling1D()(y)
