...
class Model_vault:
  ...
  def create_fcn_dct(self, single=False):
    ...
    y = layers.SeparableConv1D(4, kernel_size=3, strides=1, activation='relu', padding='same') (f)
    y = layers.SeparableConv1D(6, kernel_size=3, strides=1, activation='relu', padding='same') (y)
